      ...
      (f.createSvgTag = function (t, r, e, n) {
        ...
        for (
          c = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ",
            ...
            l += ">",
            l += n.text
              ? '<title id="' + y(n.id) + '">' + y(n.text) + "</title>"
              : "",
            l += e.text
              ? '<description id="' +
                y(e.id) +
    ...
    return (
      (f.createASCII = function (t, r) {
        ...
        var e,
          ...
          s = "";
        for (e = 0; e < a; e += 1) {
          for (o = Math.floor((e - u) / t), s = "", n = 0; n < a; n += 1)
            (i = 1),
              u <= n &&
                n < c &&
                u <= e &&
  ...
  function k(t, r) {
    ...
    var e = (function () {
      ...
      n = {
        ...
        multiply: function (t) {
          for (
            var r = new Array(n.getLength() + t.getLength() - 1), e = 0;
            e < n.getLength();
            e += 1
          )
  ...
  var A = (function () {
      ...
      return (
        (e.getRSBlocks = function (e, n) {
          ...
          if (void 0 === o)
            throw (
              "bad rs block @ typeNumber:" + e + "/errorCorrectionLevel:" + n
            );
          for (var i = o.length / 3, a = [], u = 0; u < i; u += 1)
            for (
              var f = o[3 * u + 0], c = o[3 * u + 1], l = o[3 * u + 2], h = 0;
              h < f;
              h += 1
            )
              a.push(r(c, l));
          ...
          write: function (t) {
            ...
            n < r.length &&
              (r.length - n == 1
                ...
                : r.length - n == 2 && t.put(o(r.substring(n, n + 2)), 7));
          },
        },
        o = function (t) {
      ...
      for (
        var n = (function (t, r) {
            var e = t,
              ...
              a = function (t) {
                for (
                  var r = 1 << t, e = 1 + (1 << t), n = t + 1, i = u(), a = 0;
                  a < r;
                  a += 1
                )
      ...
      for (
        var u = (function () {
            ...
            return (
              ...
              (o.flush = function () {
                if ((r > 0 && (i(t << (6 - r)), (t = 0), (r = 0)), e % 3 != 0))
                  for (var o = 3 - (e % 3), a = 0; a < o; a += 1) n += "=";
              }),
              (o.toString = function () {
                return n;
              }),
